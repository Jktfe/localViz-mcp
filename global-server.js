...
// Use the global installation of the SDK
...
🔧 Configuration:
   ...
   • Max concurrent jobs: ${parseInt(process.env.MAX_CONCURRENT_JOBS || '3', 10)}
...
// Ensure output directory exists before connecting
